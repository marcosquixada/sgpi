<?php
    ...
    if ( !empty($_POST)) {
        ...
        // insert data
        if ($valid) {
			$sql = "INSERT INTO documento (descricao) values('".$desc."')" or die("erro ao inserir");
            if(mysql_query($sql)){
				$msg = "Gravado com sucesso!";
				echo "<script>alert('Registro cadastrado com sucesso!');window.location.href='/sgpi/cadastros/documento';</script>";
			}else{
				$msg = "Erro ao gravar!";
