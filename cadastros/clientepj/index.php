...
echo "<h1 align=center style='font-family:Calibri;font-weight:bold;'>Cliente PJ</h1>";
...
while($row = mysqli_fetch_row($result))
{
	...
	echo "<td class='link'><a href=/sgpi/cadastros/excluir.php?id=".$row[0]."&modelo=clientepj&table=usuario><img src='/sgpi/_img/excluir.png' alt='Excluir' title='Excluir' height='15px' width='15px' /></a></td></tr>\n";
}
