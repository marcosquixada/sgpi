    ...
    if ( !empty($_POST)) {
        ...
        if ($valid) {
			...
			if (!$res) {
				...
				echo "<script>alert('Registro cadastrado com sucesso!');window.location.href='/sgpi/cadastros/construtora';</script>";
			}
        }
    }
?>
